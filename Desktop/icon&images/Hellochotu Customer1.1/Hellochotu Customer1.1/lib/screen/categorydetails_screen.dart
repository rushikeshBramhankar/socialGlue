...
class _CategoryDetailsScreenState extends State<CategoryDetailsScreen> {
  ...
  Future<void> onAddItem(int index, String qtys,
      ...
      productTitle1,
      productId,
      required String slogan1,
      required String logo}) async {
    String? id = id1;
  ...
  Future<void> onAddItem1(int index, String qtys,
      {String? id1,
      price1,
      strTitle1,
      per1,
                                                                    ...
                                                                    setState(
                                                                      ...
                                                                      onAddItem1(
                                                                        ...
                                                                        productId: productDetailsController
                                                                            ...
                                                                            ?.productData
                                                                            .id,
                                                                        storeSlogan1: storeDataContoller
                                                                            .storeDataInfo!
                                                                            .storeInfo
                                                                            .storeSlogan,
                                                                        logo: storeDataContoller
                                                                            .storeDataInfo!
                                                                            .storeInfo
                                                                            .storeLogo,
                                                                      );
